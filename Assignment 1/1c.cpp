...
int main() {
    ...
    packet.tcp_header.fin = 1;  // Set FIN flag
    packet.tcp_header.rst = 1;  // Set RST flag

    packet.tcp_header.seq = 0;               // Sequence number

    // Fill in the message
    const char* message = "Hello, Server! - From Attacker";
